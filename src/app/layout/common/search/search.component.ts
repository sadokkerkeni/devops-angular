...
import { SearchHistoryService } from 'app/core/search/search-history.service';
            ...
            .subscribe((value) =>
            {
                this._httpClient.post('api/common/search', {query: value})
                    .subscribe((resultSets: any) =>
                    {
                        ...
                        const resultsCount = resultSets?.length || 0;
                        this._searchHistoryService.addSearch(value, resultsCount);
