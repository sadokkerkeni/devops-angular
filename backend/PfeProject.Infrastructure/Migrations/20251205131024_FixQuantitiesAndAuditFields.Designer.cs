...
namespace PfeProject.Infrastructure.Migrations
{
    ...
    [Migration("20251205131024_FixQuantitiesAndAuditFields")]
    partial class FixQuantitiesAndAuditFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PfeProject.Domain.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PfeProject.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PfeProject.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.HasOne("PfeProject.Domain.Entities.User", "User1")
                        .WithMany("ConversationsAsUser1")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PfeProject.Domain.Entities.User", "User2")
            ...
            modelBuilder.Entity("PfeProject.Domain.Entities.Message", b =>
                {
                    b.HasOne("PfeProject.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PfeProject.Domain.Entities.User", "Sender")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("PfeProject.Domain.Entities.StockMovement", b =>
                {
                    ...
                    b.HasOne("ReturnLine", "ReturnLine")
                        .WithMany()
