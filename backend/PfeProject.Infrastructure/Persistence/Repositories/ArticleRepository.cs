...
namespace PfeProject.Infrastructure.Repositories
{
    public class ArticleRepository : IArticleRepository
    {
        ...
        public async Task<Article?> GetByCodeAndCompanyAsync(string codeProduit, int companyId)
        {
            return await _context.Articles
                .FirstOrDefaultAsync(a => a.CodeProduit == codeProduit && a.CompanyId == companyId && a.IsActive);
        }
    }
}
