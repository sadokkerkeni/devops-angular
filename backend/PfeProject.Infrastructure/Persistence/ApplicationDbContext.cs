...
namespace PfeProject.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<StockMovement> StockMovements { get; set; } // ✨ NEW
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>(entity =>
            {
                ...
                entity.HasOne(r => r.Company).WithMany(c => c.Roles).HasForeignKey(r => r.CompanyId).OnDelete(DeleteBehavior.Restrict); // 🏢 Add Company relationship
            });
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                ...
                entity.HasOne(ur => ur.Company).WithMany().HasForeignKey(ur => ur.CompanyId).OnDelete(DeleteBehavior.Restrict); // 🏢 Add Company relationship
            });
            ...
            modelBuilder.Entity<Status>(entity =>
            {
                ...
                entity.Property(s => s.Type).HasMaxLength(50); // ✨ NEW: Type field
            ...
            modelBuilder.Entity<Picklist>(entity =>
            {
                ...
                entity.Property(p => p.Quantity); // ✨ CHANGED: Now int, not string
                entity.Property(p => p.Type).HasMaxLength(100);
                entity.Property(p => p.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(p => p.ModifiedAt); // ✨ NEW: Audit field
            ...
            modelBuilder.Entity<DetailPicklist>(entity =>
            {
                ...
                entity.Property(d => d.Quantite); // ✨ CHANGED: Now int, not string
                entity.Property(d => d.IsActive).HasDefaultValue(true);
                entity.Property(d => d.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP"); // ✨ NEW: Audit field
                entity.Property(d => d.ModifiedAt); // ✨ NEW: Audit field
            ...
            modelBuilder.Entity<ReturnLine>(entity =>
            {
                ...
                entity.Property(r => r.Quantite); // ✨ CHANGED: Now int, not string
                entity.Property(r => r.DateRetour).HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(r => r.IsActive).HasDefaultValue(true); // ✨ NEW
                entity.Property(r => r.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP"); // ✨ NEW: Audit field
                entity.Property(r => r.ModifiedAt); // ✨ NEW: Audit field
                ...
                entity.HasOne(r => r.Picklist).WithMany().HasForeignKey(r => r.PicklistId).OnDelete(DeleteBehavior.SetNull).IsRequired(false); // ✨ NEW: Optional picklist link
            });
            ...
            modelBuilder.Entity<MovementTrace>(entity =>
            {
                ...
                entity.Property(mt => mt.Quantite); // ✨ CHANGED: Now int, not string
                ...
                entity.Property(mt => mt.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP"); // ✨ NEW: Audit field
                entity.Property(mt => mt.ModifiedAt); // ✨ NEW: Audit field
            ...
            modelBuilder.Entity<Inventory>(entity =>
            {
                ...
                entity.Property(i => i.IsActive).HasDefaultValue(true); // ✨ Ensure IsActive is configured
                entity.Property(i => i.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP"); // ✨ NEW: Audit field
                entity.Property(i => i.ModifiedAt); // ✨ NEW: Audit field
                entity.HasOne(i => i.Company).WithMany(c => c.Inventories).HasForeignKey(i => i.CompanyId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(i => i.Status).WithMany().HasForeignKey(i => i.StatusId).OnDelete(DeleteBehavior.Restrict); // ✨ CHANGED: Now StatusId FK
            });
            ...
            modelBuilder.Entity<Conversation>(entity =>
            {
                ...
                entity.Property(c => c.IsActive).HasDefaultValue(true);
                entity.HasOne(c => c.User1).WithMany(u => u.ConversationsAsUser1).HasForeignKey(c => c.User1Id).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(c => c.User2).WithMany(u => u.ConversationsAsUser2).HasForeignKey(c => c.User2Id).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(c => c.Company).WithMany(c => c.Conversations).HasForeignKey(c => c.CompanyId).OnDelete(DeleteBehavior.Restrict);
            });
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.HasOne(m => m.Conversation).WithMany(c => c.Messages).HasForeignKey(m => m.ConversationId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(m => m.Sender).WithMany(u => u.Messages).HasForeignKey(m => m.SenderId).OnDelete(DeleteBehavior.Restrict);
            });
            ...
            modelBuilder.Entity<StockMovement>(entity =>
            {
                ...
                entity.Property(sm => sm.QuantityBefore).IsRequired();
                entity.Property(sm => sm.QuantityAfter).IsRequired();
                entity.Property(sm => sm.QuantityChanged).IsRequired();
                entity.Property(sm => sm.Reason).HasMaxLength(500);
                entity.Property(sm => sm.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
                
                entity.HasOne(sm => sm.Sap).WithMany().HasForeignKey(sm => sm.SapId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(sm => sm.Picklist).WithMany().HasForeignKey(sm => sm.PicklistId).OnDelete(DeleteBehavior.SetNull).IsRequired(false);
                entity.HasOne(sm => sm.ReturnLine).WithMany().HasForeignKey(sm => sm.ReturnLineId).OnDelete(DeleteBehavior.SetNull).IsRequired(false);
                entity.HasOne(sm => sm.User).WithMany().HasForeignKey(sm => sm.UserId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(sm => sm.Company).WithMany().HasForeignKey(sm => sm.CompanyId).OnDelete(DeleteBehavior.Restrict);
            });
        }
    }
}