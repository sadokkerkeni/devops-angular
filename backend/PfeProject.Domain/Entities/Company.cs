...
namespace PfeProject.Domain.Entities
{
    public class Company
    {
        ...
        public virtual ICollection<Role> Roles { get; set; } = new HashSet<Role>(); // 🏢 Add Roles collection
        ...
        public virtual ICollection<Conversation> Conversations { get; set; } = new HashSet<Conversation>(); // 💬 Messagerie
    }
}
