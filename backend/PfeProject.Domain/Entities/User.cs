...
namespace PfeProject.Domain.Entities
{
    public class User
    {
        ...
        // 💬 Messagerie
        public virtual ICollection<Conversation> ConversationsAsUser1 { get; set; } = new HashSet<Conversation>();
        public virtual ICollection<Conversation> ConversationsAsUser2 { get; set; } = new HashSet<Conversation>();
